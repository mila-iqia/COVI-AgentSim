...
class ServerTests(unittest.TestCase):
    ...
    def start_server():
        with unittest.mock.patch("covid19sim.server_utils.proc_human_batch") as mock:
            broker = covid19sim.distributed_inference.server_utils.InferenceBroker(
                model_exp_path=covid19sim.distributed_inference.server_bootstrap.default_model_exp_path,
                workers=2,
                verbose=True,
    ...
    def start_client():
        ...
        time.sleep(6)
        remote_engine = covid19sim.distributed_inference.server_utils.InferenceClient()
