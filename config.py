...
AVG_NUM_SHOP_PER_WEEK = 5
SCALE_NUM_SHOP_PER_WEEK = 2
AVG_SCALE_NUM_SHOP_PER_WEEK = 1
SCALE_SCALE_NUM_SHOP_PER_WEEK = 0.5
...
AVG_NUM_EXERCISE_PER_WEEK = 5
SCALE_NUM_EXERCISE_PER_WEEK = 2 
AVG_SCALE_NUM_EXERCISE_PER_WEEK = 1
SCALE_SCALE_NUM_EXERCISE_PER_WEEK =	0.5
