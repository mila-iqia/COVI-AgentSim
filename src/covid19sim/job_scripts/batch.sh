...
- In that pickle file, we have data in a format specified in the docs/models.md of the simulator's repo (link is provided below).
...
- https://github.com/covi-canada/simulator
- https://github.com/covi-canada/machine-learning
EOL
