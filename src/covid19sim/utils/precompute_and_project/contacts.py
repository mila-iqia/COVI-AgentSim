...
if __name__ == "__main__":
    ...
    assert "P_CONTACT" not in region, "P_CONTACT already exist. Delete it if you want to overwrite it."
    ...
    comment = """
##################################################################
## Pre-computed using utils/precompute_and_project/contacts.py  ##
##################################################################
