...
def _get_disease_days(rng, conf, age, inflammatory_disease_level):
    ...
    INFECTIOUSNESS_ONET_DAYS_AVG = conf['INCUBATION_DAYS_GAMMA_SHAPE'] - conf['INFECTIOUSNESS_ONSET_DAYS_WRT_INCUBATION_AVG']
    infectiousness_onset_days = rng.gamma(
                                    shape=INFECTIOUSNESS_ONET_DAYS_AVG,
