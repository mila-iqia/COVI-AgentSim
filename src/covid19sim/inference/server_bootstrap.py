...
def main(args=None):
    ...
    if args.frontend is not None:
        ...
        frontend_address = covid19sim.inference.server_utils.default_frontend_ipc_address
    if args.backend is not None:
        ...
        backend_address = covid19sim.inference.server_utils.default_backend_ipc_address
