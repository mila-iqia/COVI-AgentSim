...
INFECTIOUSNESS_ONSET_DAYS_WRT_SYMPTOM_ONSET = (
    2.5
)  # relative to incubation days FIXME:unused
...
P_TEST = 0.3
P_TEST_SYMPTOMATIC = 0.3  # FIXME:unused
P_TEST_ASYMPTOMATIC = 0.05  # FIXME:unused
TEST_DAYS = 5
...
COLD_INCUBATION = 1 # FIXME:unused
