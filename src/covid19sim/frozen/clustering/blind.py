...
class BlindCluster(ClusterBase):
    ...
    def create_cluster_from_message(
        ...
        return BlindCluster(
            ...
            cluster_id=cluster_id,  # might still be output in embeddings, but is essentially garbo
    ...
    def get_embeddings_array(self) -> np.ndarray:
        ...
        if self.generate_embeddings_by_timestamp:
            ...
            for cluster in self.clusters:
                ...
                for msg in cluster.messages:  # todo change for timestamp map & set val below
